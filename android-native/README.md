...
- аварийная блокировка viewer по паролю
- встроенный видеоплеер в зоне медиа (не внизу экрана)
- индикатор скачивания + загрузка фото/видео
- базовый экран плагинов (локальные флаги + GitHub каталог)
